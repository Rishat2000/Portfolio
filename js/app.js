(() => {
    ...
    (() => {
        ...
        const spollersTitle = document.querySelectorAll(".sp-title");
        spollersTitle.forEach((function(spollerTitle) {
            if (spollerTitle) spollerTitle.addEventListener("click", (function(e) {
